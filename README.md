...
$$\begin{aligned}
    (\theta^{(K)}_{1}-\theta^*_1)^2&\leq  C\left[\frac{G^2}{\color{OliveGreen}{(K+1)}}+\color{BrickRed}{m^{-\frac{1}{2}+\varepsilon}}\right],\\
    (\theta^{(K)}_{1}-\theta^*_1)^2&\leq  C\left[\frac{G^2}{\color{OliveGreen}{(K+1)}}+\color{BrickRed}{m^{-\frac{1}{2}+\varepsilon}}\right].
\end{aligned}$$
...
$$\begin{aligned}
\|\nabla \ell(\boldsymbol{\theta}^{(K)})\|_2^2\leq C\left[\frac{G^2}{\color{OliveGreen}{K+1}}+\color{BrickRed}{m^{-\frac{1}{2}+\varepsilon}}\right].
\end{aligned}$$
